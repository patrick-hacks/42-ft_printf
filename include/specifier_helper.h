...
/*   Updated: 2022/04/03 10:57:52 by pfuchs           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
uint64_t	get_with_length_unsigned(uint8_t *flags, va_list args);
uint64_t	get_with_length_signed(uint8_t *flags, va_list args);
